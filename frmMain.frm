...
Private Sub MDIForm_Load()
    ...
    bColour = GetSetting(App.Title, "Settings", "Colour", &H80000005)
End Sub
...
Private Sub LoadNewDoc()
    ...
    frmD.rtfText.BackColor = bColour
    frmD.Show
End Sub
...
Private Sub MDIForm_Unload(Cancel As Integer)
    If Me.WindowState <> vbMinimized Then
        ...
        SaveSetting App.Title, "Settings", "Colour", bColour
    End If
End Sub
...
Private Sub tbToolBar_ButtonClick(ByVal Button As MSComCtlLib.Button)
    ...
    Select Case Button.Key
        ...
        Case "Font"
            ...
            Me.dlgCommonDialog.FontSize = ActiveForm.rtfText.SelFontSize
            Me.dlgCommonDialog.FontName = ActiveForm.rtfText.SelFontName
            Me.dlgCommonDialog.FontBold = ActiveForm.rtfText.SelBold
            Me.dlgCommonDialog.FontItalic = ActiveForm.rtfText.SelItalic
            Me.dlgCommonDialog.ShowFont
            ActiveForm.rtfText.SelFontName = Me.dlgCommonDialog.FontName
            ActiveForm.rtfText.SelFontSize = Me.dlgCommonDialog.FontSize
            ActiveForm.rtfText.SelItalic = Me.dlgCommonDialog.FontItalic
            ActiveForm.rtfText.SelBold = Me.dlgCommonDialog.FontBold
        Case "BkColour"
            Me.dlgCommonDialog.ShowColor
            ActiveForm.rtfText.BackColor = Me.dlgCommonDialog.Color
            bColour = Me.dlgCommonDialog.Color
    End Select
End Sub
...
Private Sub mnuFileSaveAs_Click()
    ...
    With dlgCommonDialog
        ...
        .Filter = "All Files (*.*)|*.*|Encrypted Text Files (*.etf)|*.etf|"
        .FilterIndex = 2
        .ShowSave
    ...
    If Crypt(sFile, ActiveForm.Tag) Then
    End If

End Sub

Private Sub mnuFileSave_Click()
    Dim sFile As String, EncryptionKey As String, Pass1 As String
    ...
    If ActiveForm.Tag = "" Then
redo:
        Pass1 = InputBox("Please Eneter as password for this file", "Enter Password")
        If Pass1 = "" Then
        MsgBox "You need to enter a password!"
        GoTo redo
        End If
        ActiveForm.Tag = Pass1
    End If
    
    
    If ActiveForm.Tag <> "" Then
        EncryptionKey = ActiveForm.Tag
        If Crypt(sFile, EncryptionKey) Then
        End If
    End If
    ActiveForm.Caption = sFile
...
Private Sub mnuFileOpen_Click()
    ...
    If Pass1 <> "" Then
        ActiveForm.Tag = Pass1
        If ViewCrypt(ActiveForm.Caption, ActiveForm.Tag) Then
     End If
    
    Else
    MsgBox "Cannot load file without password", vbOKOnly + vbCritical, "Error"
    Unload ActiveForm
    Exit Sub
    End If
    ActiveForm.rtfText.LoadFile "c:\windows\temp.cfg"

Kill "c:\windows\temp.cfg"
